...
private:
    ...
    /// @brief The discard pile of the deck, containing cards that have been used or discarded by players.
...
template <typename T>
CardDeck<T>::CardDeck(const std::vector<T *> &cards) : drawPile(cards)
{
}
