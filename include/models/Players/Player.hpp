...
private:
    ...
    /// @brief resets to 0 if a non-double is rolled or if the player goes to jail after rolling 3
    /// doubles.
...
public:
    ...
    /// @brief Creates a player with a unique id and username.
...
Player::Player(int id, const std::string& username)
