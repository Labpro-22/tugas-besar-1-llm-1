...
public:
    ...
    TaxTile(const int id, const std::string& code, const std::string& name, TaxType type,
            int baseAmount, int percentage);
    ~TaxTile();
};

TaxTile::TaxTile(const int id, const std::string& code, const std::string& name, TaxType type,
                 int baseAmount, int percentage)
