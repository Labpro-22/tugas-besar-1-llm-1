...
private:
  ...
  int rentBasePrice;
  /// @brief The current number of houses built on this street (0-4), 5 indicates a hotel is built.
  int propertyLevel = 0;
...
public:
  ...
  StreetTile(const int id, const std::string &code, const std::string &name, const int price, std::string color, int rentBasePrice, int housePrice, int hotelPrice);
  ~StreetTile();

  /// @brief Calculates the rent for this street based on its current level of development and any active festivals.
...
StreetTile::StreetTile(const int id, const std::string &code, const std::string &name, const int price, std::string color, int rentBasePrice, int housePrice, int hotelPrice) : PropertyTile(id, code, name, price), color(color), rentBasePrice(rentBasePrice), housePrice(housePrice), hotelPrice(hotelPrice)
{
}
